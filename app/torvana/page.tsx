        ...
        <section className="tv-intake-showcase tv-shell">
          <div className="tv-intake-showcase-inner">
            <div className="tv-intake-showcase-copy">
              ...
              <p>Torvana builds a branded intake experience for your center — your logo, your colors, your exam types. It can be embedded on your practice website or shared as a direct link. Patients complete their health history and sign HIPAA authorization before they walk in. No app, no account, no paper.</p>
          ...
          <div className="tv-faq-grid">
            ...
            <div className="tv-faq-list">
              {[
                ...
                { q: 'How does patient intake work?', a: 'Intake runs in any browser — phone, tablet, or desktop. It can be embedded directly on your practice website or shared as a link. Patients complete their health history, consent forms, and HIPAA authorization digitally, with e-signature built into the flow. No app to download, no account to create.' },
