...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Automate intake qualification, speed-to-lead outreach, and document generation for workers' comp firms. Sign more cases, work fewer hours.",
    images: [
      {
        url: '/images/intake-scoring.png',
        width: 1200,
        height: 630,
        alt: "Case Compass Workers' Comp Intake",
      },
    ],
  },
  twitter: {
    ...
    images: ['/images/intake-scoring.png'],
  },
}
...
const workersCompBreadcrumb = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'Solutions', item: 'https://www.casecompass.io/solutions' },
    {
      '@type': 'ListItem',
      position: 3,
      name: "Workers' Compensation Intake Software",
      item: 'https://www.casecompass.io/solutions/workers-comp',
    },
  ],
}

const workersCompSoftwareSchema = {
  '@context': 'https://schema.org',
  '@type': 'SoftwareApplication',
  name: "Case Compass Workers' Compensation Intake",
  applicationCategory: 'BusinessApplication',
  applicationSubCategory: "Workers' Compensation Intake Software",
  operatingSystem: 'Web',
  url: 'https://www.casecompass.io/solutions/workers-comp',
  description:
    "IntakeOS for workers' compensation firms — AI qualification, speed-to-lead, bilingual intake, document generation, and referral tracking.",
  offers: {
    '@type': 'Offer',
    price: '0',
    priceCurrency: 'USD',
  ...
  featureList: [
    'Waypoint AI qualification for workers\' comp',
    'Instant speed-to-lead outreach',
    'Automated retainer and document generation',
    'Spanish and bilingual intake',
...
export default function WorkersCompLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(workersCompSoftwareSchema) }} />
      {children}
    </>
  )
}
