  ...
  return (
    <div style={{ fontFamily: 'var(--font-body)', color: '#0f172a', background: '#fff', overflowX: 'hidden' }}>
      ...
      <footer style={{ background: '#060d1f', borderTop: '1px solid rgba(255,255,255,0.06)', padding: '28px 40px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '12px' }}>
        ...
        <p style={{ fontSize: '0.75rem', color: 'rgba(255,255,255,0.2)', margin: 0, maxWidth: '560px', textAlign: 'right' }}>Case Compass is not a law firm and does not provide legal advice. This page is intended for law firms and legal intake operations evaluating intake automation software for social media addiction litigation.</p>
      </footer>
