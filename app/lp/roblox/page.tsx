    ...
    <div style={{ fontFamily: 'var(--font-body)', color: '#0f172a', background: '#fff', overflowX: 'hidden' }}>
      ...
      <section style={{ background: 'linear-gradient(135deg, #060d1f, #1e1b4b)', padding: '80px 40px', textAlign: 'center' }}>
        <SectionReveal>
          ...
          <Link href="https://calendly.com/casecompass/case-compass-intro" target="_blank" rel="noopener" style={{ display: 'inline-block', background: 'linear-gradient(135deg, #4f46e5, #7c3aed)', color: '#fff', padding: '14px 32px', borderRadius: '8px', fontFamily: 'var(--font-display)', fontSize: '1rem', fontWeight: 700 }}>
            Schedule a Demo →
          </Link>
        </SectionReveal>
      </section>
